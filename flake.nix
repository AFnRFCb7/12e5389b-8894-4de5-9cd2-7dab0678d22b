        ...
        { self } :
            {
                lib =
                    let
                        implementation = { arguments ? { } , current-time ? 0 , nixpkgs , system , user ? "me" , visitor , working-directory ? "$TMPDIR" } :
                            stash :
                                {
                                    outputs =
                            ...
                            in
                                {
                                    ...
                                    test =
                                        { arguments ? { } , current-time ? 0 , nixpkgs , outputs , stash , success ? true , system , user ? "me" , visitor , working-directory ? "$TMPDIR" } :
                                            let
